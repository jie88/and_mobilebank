define(function(require, exports, module) {
	...
	mui.plusReady(function() {
	    ...
	    fundCollectionQuery = function(){
			...
			mbank.apiSend("post",url,dataNumber,querySuc,queryError,true);
	    ...
	    mui('#fundCollectionList').on('tap','li',function(event) {
      		...
      		mbank.openWindowByLoad("../cashSweep/cashSweepHisDetail.html","cashSweepHisDetail", "slide-in-right",params);
		});
		loadAccountList();
