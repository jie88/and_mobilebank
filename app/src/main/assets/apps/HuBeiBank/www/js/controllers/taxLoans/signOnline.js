define(function(require, exports, module) {
	...
	mui.plusReady(function() {
		...
		$("#signAccount").html(format.dealAccountHideFour(accountNo));
		$("#signMoney").html(format.formatMoney(applyMoney));
		$("#payType").html(payType);
		$("#loanDate").html(loanDate);
		...
		$("#next").on('tap',function(){
			...
			mbank.openWindowByLoad('../taxLoans/contractView.html','contractView','slide-in-right',params);
